    ...
    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
      <form>
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          ...
          <div>
            <h1 class="font-bold text-center mb-4">BUAT DATA</h1>
          </div>
          <div>
            <div class="mb-2">
            ...
            <div class="mb-2">
              <label for="title" class="block">Nama Sayur </label>
              <input wire:model="title" type="text" class="shadow apperance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Input Nama">


              <div class="mb-2">
                <label for="title" class="block">Jumlah Pesanan</label>
                <textarea wire:model="description" name:"description" class="shadow apperance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Input Deskripsi"></textarea>
